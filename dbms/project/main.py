...
def slotbooking():
    ...
    if request.method=="POST":
        ...
        # for key, value in dbb.__dict__.items():
        #     print(f"{key}: {value}")
        # print(Hospitaldata) 
        # dbbb=Hospitaldata.get_json()
        # print(dbbb)
        # bedtype=bedtype
        ...
        # for key, value in dbb.__dict__.items():
        #     if(key=="normalbed" and bedtype=="NormalBed"):
        #         value=value-1
        #         db.session.commit()
        #     elif(key == "hicubed"and bedtype=="HICUBed" ):
        #         value=value-1
        #         db.session.commit()
        #     elif(key=="icubed"and bedtype=="ICUBed"):
        #         value=value-1
        #         db.session.commit()
        #     elif(key=="vbed" and bedtype=="VENTILATORBed"):
        #         value=value-1
        #         db.session.commit()
            
        # elif bedtype=="HICU Bed":      
        #     seat=dbb.hicubed
        #     print(seat)
